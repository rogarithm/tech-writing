...
as> Do not put excessive pressure on the socket.

4. 스위치를 왼쪽 끝까지 미세요.

as> Slide the switch to the left end.
...
as> It is 26% larger than the maximum value

7. 원하는 횟수만큼 버튼을 누르세요.

as> Push the button as many times as you want.
