...
as> "When the product is turned off", set up the phone to forward to another number.
...
as> "Input wait window" shows up including the following message.

3. 설명이 말풍선 도움말로 표시됩니다.

as> The description appears as "balloon help text".

4. 누를 때마다 네 개의 표시 모드가 번갈아가며 나타납니다.

as> The four display mode "appear in turn" "with each tap".

5. 그것은 규정한 수만큼 데이터 로그를 표시할 수 있습니다.

as> It displays data logs for the specified number.
