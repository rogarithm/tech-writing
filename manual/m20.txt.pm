...
2. B의 경우도 같은 방법으로 작동한다.

as> B works the same way.

3. 딸깍 소리가 들릴 때까지 커넥터를 누르세요.

as> Press the connector until you hear the click sound.

4. 스마트폰의 애플리케이션을 길게 누르고 다른 애플리케이션 위로 드래그하세요.
...
as> On, Off switches alternately.

6. 설치 후 케이블을 정리하세요.

as> Organize the power cable after installation.

7. 화면에 흩어져 있는 항목들을 정리하세요.

as> Arrange scattered items on the screen.
