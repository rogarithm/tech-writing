...
as> iron and vessels must not be put on the product. there's a danger of and fire when they're in the product, it also can be a reason for product damage.

2. 청소를 위해 제품에 물을 뿌리거나 본체를 물로 씻어서는 안 된다.

as> do not sprinkle water to the product or cleansing the main part with water for cleaning

3. 제품에서 크고 이상한 소리가 나거나 연기와 함께 타는 냄새가 나면 즉시 전원 플러그를 뺀 후 서비스센터에 연락해야 한다.

new-thought> When the product makes loud and weird sound or smells burning with smoke, disconnect the power plug from the outlet and contact the customer service center.

as> If a big and weird sound from the product or smells burning with smoke, pull the power plug immediately, and call the service center.
...
as> The warm water is high temperature, care is required especially when young children uses.
