...
 You have to make the test next month.
...
 The air conditioners will keep the temperature. 

A simple design also minimizes costs.
 A simple design also lowers costs.
